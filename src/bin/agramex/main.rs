...
fn update() {
    let grammar_text_input: HtmlTextAreaElement = document()
        .get_element_by_id("grammar_input")
        .unwrap()
        .dyn_into::<HtmlTextAreaElement>()
        .unwrap();
    let text_input: HtmlTextAreaElement = document()
        .get_element_by_id("text_input")
        .unwrap()
        .dyn_into::<HtmlTextAreaElement>()
        .unwrap();
